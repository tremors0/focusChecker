...
helm upgrade  --install ${RELEASE_NAME} ./chart/${CHART_NAME} --namespace ${CLUSTER_NAMESPACE} --set image.repository=${IMAGE_REPOSITORY},image.tag=${BUILD_NUMBER},services.visualRecognition.secretKeyRef=${VISUALRECOGNITION}
